...
class AddDigitalProductOffered extends ConsumerStatefulWidget {
  const AddDigitalProductOffered({super.key});

  @override
  AddDigitalProductOfferedState createState() =>
      AddDigitalProductOfferedState();
}

class AddDigitalProductOfferedState
    extends ConsumerState<AddDigitalProductOffered> {
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen<String?>(createDigitalProductsOfferedErrorMsgProvider,
        (previous, next) {
      if (next != null) {
    ...
    ref.listen<String?>(createDigitalProductsOfferedSuccessMsgProvider,
        (previous, next) {
      if (next != null) {
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      if (file == null) {
                        CustomSnackbar.showSnackbar(
                            context, 'Digital Product Cant be Empty', false);
                      }
                      ref
                          .read(
