...
class EditServicePackages extends ConsumerStatefulWidget {
  final ServicePackageModel servicePackageModel;
  const EditServicePackages({super.key, required this.servicePackageModel});

  @override
  EditServicePackagesState createState() => EditServicePackagesState();
}

class EditServicePackagesState extends ConsumerState<EditServicePackages> {
  ...
  void initState() {
    super.initState();
    title.text = widget.servicePackageModel.title;
    price.text = widget.servicePackageModel.price.toString();
    ref.read(oneToOneSessionViewModelProvider).when(
          data: (oneToOneSessions) {
            if (oneToOneSessions.isNotEmpty) {
              final oneToOneSession = oneToOneSessions.firstWhere(
                (oneToOneSession) {
                  return oneToOneSession.id ==
                      widget.servicePackageModel.oneToOneSessionServiceId!.id;
                },
              ...
              oneToOneSessionTitleController.text = oneToOneSession.title;
              oneToOneSessionIdController.text = oneToOneSession.id.toString();
            }
          },
          loading: () {},
          error: (e, st) {},
    ...
    ref.read(priorityDmServiceViewModelProvider).when(
          data: (priorityDmServices) {
            if (priorityDmServices.isNotEmpty) {
              final priorityDmService = priorityDmServices.firstWhere(
                (priorityDmService) {
                  return priorityDmService.id ==
                      widget.servicePackageModel.priorityDmServiceId!.id;
                },
                orElse: () => const ServiceModel(
                  title: '',
                  price: 0,
              ...
              priorityDMServiceController.text = priorityDmService.title;
              priorityDMServiceIdController.text =
                  priorityDmService.id.toString();
            }
          },
          loading: () {},
          error: (e, st) {},
        );
    ref.read(digitalProductsOfferedViewModelProvider).when(
          data: (digitalProductsOffered) {
            if (digitalProductsOffered.isNotEmpty) {
              final digitalProductOferred = digitalProductsOffered.firstWhere(
                (digitalProductOferred) {
                  return digitalProductOferred.id ==
                      widget.servicePackageModel.digitalProductServiceId!.id;
                },
                orElse: () => const ServiceModel(
                  title: '',
                  price: 0,
              ...
              digitalProductController.text = digitalProductOferred.title;
              digitalProductIdController.text =
                  digitalProductOferred.id.toString();
            }
          },
          loading: () {},
          error: (e, st) {},
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen<String?>(updateServicePackagesErrorMsgProvider,
        (previous, next) {
      if (next != null) {
    ...
    ref.listen<String?>(updateServicePackagesSuccessMsgProvider,
        (previous, next) {
      if (next != null) {
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      ref
                          ...
                          .update(
                            ServicePackageModel(
                              id: widget.servicePackageModel.id,
